...
// // whether decrypted DATA payload is a chat control/message frame.
...
// // frames from the QUIC stream and dispatches them to appropriate handlers.
// //
// // RESPONSIBILITIES:
// //   - Frame type detection and basic parsing.
// //   - State-machine transitions for HELLO / AUTH / REGISTER.
// //   - Dispatching ACK events to AckManager.
// //   - Decrypting and interpreting DATA frames (chat / app payloads).
// //   - Emitting high-level events on dedicated channels.
// //
// // THREAD SAFETY:
// //   - Captures required references under lock before starting the goroutine.
// //   - Uses internal locking only when accessing mutable client state.
...
// 			if err != nil {
// 				// Dynamic disconnect handler (UI / app can override).
// 				c.mu.Lock()
...
// 			// ------------------------------------------------------------
// 			// MEOW_OK — generic success response (HELLO / AUTH / REGISTER / DATA)
// 			// ------------------------------------------------------------
...
// 			// ------------------------------------------------------------
// 			// ERROR — error response (HELLO / AUTH / REGISTER / generic)
// 			// ------------------------------------------------------------
...
// 			// ------------------------------------------------------------
// 			// DATA — E2EE chat payload or other application data
// 			// ------------------------------------------------------------
...
// 				// Try to interpret as a chat control/message frame.
...
// 					// Chat frame fully handled, proceed to next frame.
// 					continue
// 				}

// 				// Fallback: raw application data delivered to appHandler.
// 				if appHandler != nil {
// 					appHandler(df.Sender, []byte(plaintext))
// 				}

// 			// ------------------------------------------------------------
// 			// STATUS_RES — response to GET_STATUS
// 			// ------------------------------------------------------------
